...
// let machine2 = new VigenereCipheringMachine(false);
// let machine3 = new VigenereCipheringMachine(true);

// console.log(machine2.encrypt('attack at dawn!', 'alphonse'));
// console.log(machine2.decrypt('AEIHQX SX DLLU!', 'alphonse'));